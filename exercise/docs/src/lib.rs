...
impl Pumpkin {
    /// if you smash the pumpkin, it will be gone and it can't be used for the pie 😂
    pub fn smash(self) {}
}
...
/// `BURNT_ORANGE is the "orangeness" field in the [Pumpkin] struct.
...
/// The command is `cargo doc --no-deps --document-private-items --open`
